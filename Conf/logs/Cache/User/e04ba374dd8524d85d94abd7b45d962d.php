...
<head>
	...
	<title>自定义插件</title>
	<link href="<?php echo ($staticPath); ?>/tpl/static/img/css/reset.css" rel="stylesheet" type="text/css" /> 
	<link href="<?php echo ($staticPath); ?>/tpl/static/img/css/codemirror.css" rel="stylesheet" type="text/css"/>
	<link href="<?php echo ($staticPath); ?>/tpl/static/img/css/farbtastic.css" rel="stylesheet" type="text/css"/> 
</head>
<body>
	<div class="big_main"> 
    	<div class="m"> 
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <section style="text-align: center; margin: 0 1em; line-height: 1.6em; ">
	             <img style="height: 36px !important;width: 100%; vertical-align: middle;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640.png" />
	        ...
	        <div style="display: none;" id="tab2" class="tab_con"> 
	         <div class="element-list" style="width: 100%;"> 
	          ...
	          <div class="element-item" data-color="blockquote:border-color"> 
	           <div class="content"> 
	            <blockquote style="margin: 0px; padding: 20px 15px 15px 48px; border: 1px solid #00BBEC; border-radius: 5px; line-height: 1.5; background-image: url(<?php echo ($staticPath); ?>/tpl/static/img/images/mmbizgif.gif); background-position: 10px 11px; background-repeat: no-repeat;">
	             <p class="ue_t">可在这输入内容， 微信编辑器，微信编辑器。</p>
	            </blockquote> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color="blockquote:border-color"> 
	           <div class="content"> 
	            <blockquote style="margin: 0px; padding: 20px 15px 15px 48px; border: 1px solid #00BBEC; border-radius: 5px; line-height: 1.5; background-image: url(<?php echo ($staticPath); ?>/tpl/static/img/images/mh.png); background-position: 10px 11px; background-repeat: no-repeat;">
	             <p class="ue_t">可在这输入内容， 微信编辑器，微信编辑器。</p>
	            </blockquote> 
	           </div> 
	          </div> 
	            ...
	            <section> 
	             <section style="background-color: white; border: 1px solid #00BBEC; box-shadow: rgb(165, 165, 165) 0em 1em 0.1em -0.6em; line-height: 1.6em;">
	              ...
	              <section style="text-align: left; margin-top: 1.5em;">
	               <img style="vertical-align: top; margin-left: 1em; width: 30px;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_006.png" />
	               <section style="display: inline-block; width: 40%; margin-left: 0.5em; padding: 0.2em;">
	                时间
	               </section>
	              </section>
	              <section style="text-align: left; margin-top: 1em;">
	               <img style="vertical-align: top; margin-left: 1em; width: 30px;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_002.png" />
	               <section style="display: inline-block; width: 40%; margin-left: 0.5em; padding: 0.2em;">
	                地点
	               </section>
	              </section>
	          ...
	          <div class="element-item" data-color="blockquote:border-color"> 
	           <div class="content"> 
	            <p>&nbsp;</p> 
	            <section style="color: rgb(51, 51, 51); font-family: sans-serif, Arial, Verdana, 'Trebuchet MS'; background: url(<?php echo ($staticPath); ?>/tpl/static/img/images/line-bg.png) 104px 30px repeat-y;"> 
	             <p style="line-height: 40px;font-size:24px;">2014年</p> 
	             <h1 style="line-height: 40px;margin-top:-40px; margin-left: 85px; padding-left: 60px; top: 0px; color: rgb(88, 166, 251); font-size: 24px; background: url(<?php echo ($staticPath); ?>/tpl/static/img/images/clock.png) 0% 0% no-repeat;">台更新日志</h1> 
	             <section style="clear: both; line-height: 32px;"> 
	              <p style="line-height: 32px;">&nbsp;</p> 
	              <p style="font-size: 20px; line-height: 32px;">9月8日</p> 
	              <p style="margin-top: -42px; margin-left: 90px;"><img src="<?php echo ($staticPath); ?>/tpl/static/img/images/circle-h.png" style="vertical-align:bottom" /></p> 
	              ...
	              <p style="margin-top: -42px; margin-left: 90px; line-height: 32px;"><img src="<?php echo ($staticPath); ?>/tpl/static/img/images/circle-h.png" style="vertical-align:bottom" /></p> 
	              <section style="margin-left: 140px; margin-top: -32px;"> 
	        ...
	        <div style="display: none;" id="tab3" class="tab_con"> 
	         <div class="element-list" style="width: 100%;"> 
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_018.gif" width="100%" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_036.gif" /></p> 
	           </div> 
	          </div> 
	               ...
	               <section style="max-width:100%;color:#222;font-family:微软雅黑,arial,sans-serif;font-size:14px;height:75px;background-color:#fff;word-wrap:break-word!important;box-sizing:border-box!important">
	                <section class="main" style="max-width:100%;word-wrap:break-word!important;box-sizing:border-box!important;border-top-left-radius:50px;border-top-right-radius:50px;border-bottom-right-radius:50px;border-bottom-left-radius:50px;padding:5px;border:2px solid #00bbec;margin:0">
	                 <section style="max-width:100%;word-wrap:break-word!important;box-sizing:border-box!important;display:inline-block;float:left;height:60px;width:60px">
	                  <img class="awb_avatar" data-src="imges/0.png" data-ratio="1" data-w="60" _width="60px" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_008.png" style="max-width:100%;word-wrap:break-word!important;box-sizing:border-box!important;height:auto!important;border:0;border-top-left-radius:30px;border-top-right-radius:30px;border-bottom-right-radius:30px;border-bottom-left-radius:30px;width:60px!important;float:left;visibility:visible!important" />
	                  <img data-src="imges/01.png" data-ratio="1" data-w="20" src="<?php echo ($staticPath); ?>/tpl/static/img/images/01.png" style="max-width:100%;word-wrap:break-word!important;box-sizing:border-box!important;height:auto!important;border:0;float:right;margin-top:-60px;width:auto!important;visibility:visible!important" />
	                 </section>
	           ...
	           <div class="content"> 
	            <section style="text-align: left; vertical-align: top;"> 
	             ...
	             <section class="awb-s2" style="margin: 0px; height: 2.5em; border-radius: 2em; background-color: #00BBEC;">
	              <img style="height: 1.6em; vertical-align: top; margin: 0.5em 0.6em;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_008.png" />
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640.jpg" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_013.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_010.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_023.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_016.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_005.png" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_003.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_014.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_030.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0.png" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_002.png" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_009.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_006.png" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_024.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_005.jpg" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_003.jpg" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_021.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_003.png" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_015.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_031.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_006.jpg" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_002.jpg" /></p> 
	           </div> 
	          </div>
	         </div> 
	        </div> 
	        <div style="display: none;" id="tab4" class="tab_con"> 
	         <div class="element-list" style="width: 100%;"> 
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/gezi.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_025.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_034.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_005.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_012.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_037.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_002.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_020.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_002.jpg" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_007.jpg" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_029.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_007.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_027.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_040.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_004.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_004.png" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important; width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_035.gif" /></p> 
	           </div> 
	          </div> 
	          ...
	          <div class="element-item" data-color="section:background-color;"> 
	           <div class="content"> 
	            <section style="height: 10px; background: url(<?php echo ($staticPath); ?>/tpl/static/img/images/640_1.png) repeat-x #00BBEC;"></section> 
	           </div> 
	          </div>
	         </div> 
	        </div> 
	         ...
	         <div class="element-list" style="width: 100%;"> 
	           ...
	           <div class="content"> 
	            <section> 
	             <section style="height: 8em; white-space: nowrap; overflow: hidden;">
	              <img style="max-width: 100%;max-height: 100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_009.png" />
	             </section> 
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            ...
	            <p><img src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_008.gif" style="border-width: 0px; height: auto !important; visibility: visible !important;" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            ...
	            <p><img src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_011.gif" /></p> 
	           </div> 
	          </div> 
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_038.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_026.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_033.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="height: auto !important;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_006.gif" /></p> 
	           </div> 
	          </div>
	         </div> 
	        </div> 
	        <div style="display: none;" id="tab6" class="tab_con"> 
	         <div class="element-list" style="width: 100%;"> 
	             ...
	             <section style="margin:0;background-color:#fff;border:1px solid #e2e2e2;box-shadow:#e2e2e2 0 1em .1em -.8em;font-size:1em;line-height:1em;padding:.3em">
	              <section class="main" style="padding:.5em;background-color:rgb(0, 187, 236)">
	               <section style="margin-top:0;margin-left:8px">
	                <img style="width:50px;float:right;margin-top:12px;margin-right:10px" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_010.png" /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
	           ...
	           <div class="content"> 
	            ...
	            <fieldset class="tn-Powered-by-XIUMI" style="margin:.5em 0;padding:0;max-width:100%;box-sizing:border-box;color:#3e3e3e;font-family:'Helvetica Neue',Helvetica,'Hiragino Sans GB','Microsoft YaHei',&Icirc;&cent;&Egrave;&iacute;&Ntilde;&Aring;&ordm;&Uacute;,Arial,sans-serif;font-size:15px;line-height:24px;white-space:normal;border:none;text-align:center;word-wrap:break-word!important;background-color:#fff">
	             ...
	             <section class="tn-Powered-by-XIUMI" style="margin:1.3em 0 0;padding:0;max-width:100%;box-sizing:border-box;width:668px;word-wrap:break-word!important">
	              <img data-src="<?php echo ($staticPath); ?>/tpl/static/img/images/20130303205827_VMAes.thumb.600_0.jpeg" class="tn-Powered-by-XIUMI" data-ratio="0.6659619450317125" data-w="473" _width="100%" src="<?php echo ($staticPath); ?>/tpl/static/img/images/20130303205827_VMAes.jpg" style="margin:-1.5em 0 0;padding:1em;max-width:100%;box-sizing:border-box;float:left;border-top-left-radius:.5em;border-top-right-radius:.5em;border-bottom-right-radius:.5em;border-bottom-left-radius:.5em;width:80%;border:.1em solid #ccc;text-align:start;height:auto!important;word-wrap:break-word!important;visibility:visible!important" />
	             </section>
	            </fieldset>
	            <p><br /></p> 
	           </div> 
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_039.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_017.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	          ...
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_019.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_007.png" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_028.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_022.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_032.gif" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <section> 
	             <section style="text-align: left;">
	              <img style="vertical-align: top; width: 40px;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640.png" />
	              <img style="vertical-align: top; margin-top: 1.8em;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_007.png" />
	           ...
	           <div class="content"> 
	            <section> 
	             <section style="text-align: right;">
	              ...
	              <img style="vertical-align: top; margin-top: 1.8em;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_004.png" />
	              <img style="vertical-align: top; width: 40px;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/640_003.png" />
	             </section> 
	            </section> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0_004.jpg" /></p> 
	           </div> 
	          </div> 
	          <div class="element-item" data-color=""> 
	           <div class="content"> 
	            <p><img style="width:100%;" src="<?php echo ($staticPath); ?>/tpl/static/img/images/0.jpg" /></p> 
	           </div> 
	          </div>
	         </div> 
	        </div> 
...
<script src="<?php echo ($staticPath); ?>/tpl/static/img/js/bang.widget.style.js" type="text/javascript"></script>
<script src="<?php echo ($staticPath); ?>/tpl/static/img/js/codemirror.js" type="text/javascript" defer="defer"></script>
<script src="<?php echo ($staticPath); ?>/tpl/static/img/js/ZeroClipboard.js" type="text/javascript" defer="defer"></script>
<script src="<?php echo ($staticPath); ?>/tpl/static/img/js/farbtastic.js" type="text/javascript"></script>
<script src="<?php echo ($staticPath); ?>/tpl/static/img/js/gongyong.js" type="text/javascript"></script> 
</body>
</html>
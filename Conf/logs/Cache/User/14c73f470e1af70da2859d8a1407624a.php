...
<td class="norightborder">
	...
	<a charset="a_oper" href="<?php echo U('Message/tosend24All',array('token'=>$token,'id'=>$actinfo['id']));?>">
		<?php if($actinfo["status"] == 0): ?>主动发送
		<?php else: ?>
			重复主动发送<?php endif; ?>

...
<TR>
	...
	<td><input type="input" class="px" id="statdate" value="<?php if($set['start'] != ''): echo (date("Y-m-d H:i",$set["start"])); else: echo (date("Y-m-d H:i",$start_date)); endif; ?>" onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})" name="start" />
		到
		<input type="input" class="px" id="enddate" value="<?php if($set['end'] != ''): echo (date("Y-m-d H:i",$set["end"])); else: echo (date("Y-m-d H:i",$end_date)); endif; ?>" name="end"  onClick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm'})"  />
	</td>
</TR>
<TR>

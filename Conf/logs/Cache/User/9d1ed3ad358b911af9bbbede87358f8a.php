...
<?php $__FOR_START_464380159__=1;$__FOR_END_464380159__=12;for($i=$__FOR_START_464380159__;$i < $__FOR_END_464380159__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择设备：
...
<?php $__FOR_START_941136310__=1;$__FOR_END_941136310__=12;for($i=$__FOR_START_941136310__;$i < $__FOR_END_941136310__;$i+=1){ ?><option value="<?php echo ($i); ?>" <?php if($i == $current_month): ?>selected = selected<?php endif; ?>><?php echo ($i); ?>月</option><?php } ?>
</select>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
选择页面：

...
<title>跳转提示</title> 
<link href="<?php echo ($staticPath); ?>/tpl/static/redirect/css/tiaozhuan.css?2015" rel="stylesheet" type="text/css"  />
 
</head>
 
<body style="background:#f4f4f4">
<div class="tiao_content<?php if(isset($message)): ?>1<?php else: endif; ?>">
 <div class="tiao_txt">
 <div class="top_txt"><?php if(isset($message)): echo($message); else: echo($error); endif; ?></div>

            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD><?php if($list['phone']): echo ($list["phone"]); else: ?>无<?php endif; ?></TD>
                  <TD><?php echo (date("Y-m-d H:i:s",$list["time"])); ?></TD> 
                  <TD><?php echo ($list["score"]); ?></TD>
                   <TD class="norightborder">
				   <a href="index.php?g=User&m=Game&a=record_del&rid=<?php echo ($list["gameid"]); ?>&id=<?php echo ($list["id"]); ?>">删除</a></TD>

...
window.shareData = {  
            ...
            "timeLineLink": "<?php echo ($f_siteUrl); echo U('Red_packet/index',array('token' => $token,'id'=>$packet_info['id']));?>",
            "sendFriendLink": "<?php echo ($f_siteUrl); echo U('Red_packet/index',array('token' => $token,'id'=>$packet_info['id']));?>",
            "weiboLink": "<?php echo ($f_siteUrl); echo U('Red_packet/index',array('token' => $token,'id'=>$packet_info['id']));?>",

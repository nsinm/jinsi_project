            ...
            if(data.errcode == 0){
                ...
                for(var index in infos){
                    ...
                    if(infos[index].isMember != 1 && infos[index].jinsi_push_type == '1'){
                        ...
                        html +=         '<p class="user_liveword user-comment-name"><span style="margin-top:10px;">该条直播为会员内容&nbsp;&nbsp;<a href="' + payUrl + '" class="weui_btn weui_btn_plain_primary jumpBt member">成为会员</a></span></p>';
                    }else{

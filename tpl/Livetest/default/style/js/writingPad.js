 ...
 * 版本：version 1.0
 */
var WritingPad = function (container) {
  var current = null;
  ...
  $(function () {
    ...
    $(document).on("click", "#myEmpty", null, function () {
      ...
      console.log($('.js-signature'),111111)
    });
  ...
  function initHtml() {
    var html = '<br/><div class="modal" id="mymodal">' +
          ...
          '<div class="modal-body">' +
            '<div class="js-signature" id="mySignature">' +
             ...
             '<div class="bd spacing">' +
                '<button type="button" class="weui_btn weui_btn_default" id="myEmpty">清空</button>' +
             '</div>'+
  ...
  function initSignature() {
    if (window.requestAnimFrame) {
      ...
      signature.jqSignature({ width: $(window).get(0).innerWidth, height: 200, border: 'none', background: '#fff', lineColor: '#ABCDEF', lineWidth: 2, autoFit:false });
      //{ width: 600, height: 200, border: '1px solid red', background: '#16A085', lineColor: '#ABCDEF', lineWidth: 2, autoFit: true }
    } else {
      alert("请加载signature.js");
      return;
    }
  }

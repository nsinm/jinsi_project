    ...
    public function payOrder ()
    {
        ...
        if($fid){
            ...
            if($orderInfo){
                ...
                $directUrl = "http://mp.jinsxy.com/wxpay/demo/js_api_call.php?order_no={$orderInfo[0]['order_no']}_{$money}&order_no={$money}&content={$orderInfo[0]['service_name']}&jinsi_sign=";
